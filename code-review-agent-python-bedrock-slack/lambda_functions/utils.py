...
def get_github_token() -> str:
    ...
    """
    secret_name = "everyday-secrets/github_token"  # Replace with your actual secret name for Github
...
def get_slack_webhook() -> str:
    ...
    Adjust the SecretId and region name based on your setup.
    """
    secret_name = "everyday-secrets/slack-webhook"  # Replace with your actual secret name for Github
    region_name = "us-east-1"  # Replace with your secrets region
